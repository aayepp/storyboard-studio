...
const _baseCard = 'border rounded-[32px] p-6 sm:p-10 shadow-sm relative overflow-hidden transition-colors duration-300';
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10">
                    <div className={`${(activeTab === 'fake_influencer' || activeTab === 'character') ? 'lg:col-span-12' : 'lg:col-span-7'} space-y-6`}>
                      ...
                      {generatedOutput && activeTab !== 'character' && activeTab !== 'fake_influencer' && (() => {
                            ...
                            return (
                              <div className="border rounded-[1.25rem] p-6 shadow-sm relative transition-all duration-300 bg-[#09151c] border-[#12313f] mt-6">
